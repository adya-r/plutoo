      ...
      <tr className="border-b">
        ...
        <td className="hover:bg-gray-200 p-2 text-center cursor-default">
          ...
          {order.status === "Processing" && (
            <span className="block text-pink-600 rounded-full text-center text-xs px-2 font-semibold">
              {order.status}
            </span>
          )}
    ...
    <Fragment>
      <div className="flex flex-col w-full my-4 md:my-0 md:w-9/12 md:px-8">
        <div className="border">
          <div className="py-4 px-4 text-lg font-semibold border-t-2 border-pink-700">
            Orders
          </div>
          <hr />
