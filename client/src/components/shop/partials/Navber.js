        ...
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-left text-center font-bold uppercase text-indigo-800 text-2xl cursor-pointer px-2 text-center"
            >
              PLUTO
            </span>
          </div>
          <div
            ...
            className="hidden lg:block flex items-left col-span-1 text-center text-indigo-800 font-bold tracking-widest uppercase text-2xl cursor-pointer"
          >
            PLUTO
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            >
              ...
              <span className="absolute top-0 ml-6 mt-1 bg-pink-700 rounded px-1 text-white text-xs hover:text-gray-200 font-semibold">
